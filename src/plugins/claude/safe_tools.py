...
OWNER_TOOL_DESCRIPTIONS = [
    ...
    ("确认", "/确认 或 /取消", "执行或取消待确认的高风险操作。"),
    ("记忆开关", "记忆开关 开/关", "启用或关闭自动事实抽取。"),
    ("模型", "/model", "查看或切换模型。"),
    ("群聊清空", "/clear", "清空当前群聊会话历史。"),
    ("信任名单", "/白名单", "管理教学审核和高风险工具的用户/群白名单。"),
    ("风格画像", "/风格 查看/导入/导入文件/设置", "维护 owner 的说话风格画像。"),
    ("风格草稿", "/用我的风格回复：...", "按 owner 风格生成回复草稿，不自动代发。"),
    ("真实原句", "/风格 原句 开/关", "控制真实历史原句 few-shot，开启需确认并审计。"),
    ("风格教学", "/教学 开/关", "影子审核信任用户私聊，并用采纳/评分/改写记录训练反馈。"),
    ("教学", "/教学 开/关", "信任用户私聊只生成候选给主人审核。"),
    ("受控 Agent", "/agent", "主人私聊中生成工具计划、审核草稿，并按确认规则执行。"),
]
